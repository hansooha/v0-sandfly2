  ...
  return (
    <div className="bg-gray-900 text-white">
      <main className="container mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl text-center mb-12">News</h1>
